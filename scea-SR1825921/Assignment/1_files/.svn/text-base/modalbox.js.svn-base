...
Extra options added:  9/04/2009: Jason Gross
				fromTop: , transitionType: 
*/
/// <reference path="../../pitbull/images_all/buttons/btn_delete_rev2.gif" />
...
Modalbox.Methods = {
	...
	options: {
		...
		fromTop: 0,	// How far from viewport top to draw the box.
		...
		transitionType: 0,	//0 is SlideUp/SlideDown, 1 is Appear/Fade
		loadingString: "Loading...", // Default loading string message
		closeString: "Close", // Default title attribute for close window link
		//closeValue: "<img src='/_media/icons/invalid.png'/>", // Default string for close link in the header
		closeValue: "<img src='/_media/icons/btn_delete_rev2.png' border='0'/>", // Default string for close link in the header
		closeEnabled: true,
		params: {},
	...
	hide: function(options) { // External hide method to use from external HTML and JS
		if(this.initialized) {
			...
			if(this.options.transitions)
				if (this.options.transitionType==0){
					Effect.SlideUp(this.MBwindow, { duration: this.options.slideUpDuration, transition: Effect.Transitions.sinoidal, afterFinish: this._deinit.bind(this) });
				}else{
					Effect.Fade(this.MBwindow, { duration: this.options.slideUpDuration, transition: Effect.Transitions.sinoidal, afterFinish: this._deinit.bind(this) } );
				}
			else {
				$(this.MBwindow).hide();
				this._deinit();
	...
	_setFocus: function() { 
		...
		} else if($(this.MBclose) && $(this.MBclose).visible())
	...
	_setPosition: function () {
		...
		$(this.MBwindow).setStyle({ top: (this.options.fromTop + "px") });
},
